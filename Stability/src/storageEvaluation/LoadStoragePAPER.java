...
public class LoadStoragePAPER {
	...
	public ArrayList<Evaluation> LoadStoredXML(String fileName){
		evaluations = new ArrayList<LoadedValue>();
		Scanner scanner;
		try {
			//System.out.println("Working Directory = " + System.getProperty("user.dir"));
			scanner = new Scanner(new FileReader("traces/"+fileName));
			String line = null;
		...
		CalcEvaluationPAPER calc=new CalcEvaluationPAPER(evaluations);
		finalEvaluations=calc.getCalculations();
		System.out.println(roName+ " " + finalEvaluations.get(finalEvaluations.size()-1).getReliability());
